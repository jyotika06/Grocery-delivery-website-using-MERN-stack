...
const SellerLogin = () => {
  ...
  return!isSeller && (
    <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
        <div className='flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:min-w-88 rounded-lh shadow border border-gray-200'>
            <p className="text-2xl font-medium m-auto">
                ...
                <button className="bg-primary text-white w-full py-2 rounded-mdr">Login</button>
        </div>
